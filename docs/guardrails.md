...
- All bundled scenarios, organizations, workload shapes, and prices are fictional or illustrative.
- No default is a live vendor quote, contract price, benchmark, or customer commitment.
...
Do not enter customer identifiers, confidential configurations, proprietary prices, credentials,
production telemetry, internal project IDs, supplier quotes, or contract terms into a public demo.
